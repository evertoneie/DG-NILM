...
configs = {
    ...
    "DATASET_PATH": "",
    "TRAIN_SIZE": 0.9,
    "FOLDER_PATH": "./DeepDFML/IDE/trained_models/",
    "FOLDER_DATA_PATH": "./DeepDFML/IDE/trained_models/",
...
for train_index, validation_index in mskf.split(X_all, strat_classes):
    ...
    # if fold != 10: # VAmos treinar um por vez... a ram tá estourando
    #    continue
    ...
    while fileEpoch < configs["TOTAL_MAX_EPOCHS"]:
        ...
        if not os.path.isfile(folderPath + 'Detect_Only_Inverter.h5'):
