...
source_models_folder = './DeepDFML/LDE/trained_models/'
...
configs = {
    ...
    "DATASET_PATH": "",
    "TRAIN_SIZE": 0.9,
    "FOLDER_PATH": "./DeepDFML/LDE/trained_models/",
    "FOLDER_DATA_PATH": "./DeepDFML/LDE/trained_models/",
...
# Verificando se existe algum valor nan no conjunto de dados da entrada
...
f, axes = plt.subplots(3, 2, figsize=(
50, 30))  # Temos 4 variáveis... então será duas linhas e duas colunas para traçar a Matriz de Confusão
axes = axes.ravel()
...
confusion_Matrix = confusion_Matrix.reshape([4, 2, 2])
...
add2 = folderDataPath + 'confusion_matrix' + "/DeepDFML" + complemento + '_' + configs["LOSS"] + '.mat'

remove_if_exists(add2)
# remove_if_exists(root_path + '/trained_models/'+ "confusion_matrix" + "/" + file_name2 + ".mat")

if normalized:
    sio.savemat(folderDataPath + 'confusion_matrix' + "/DeepDFML" + complemento + '_' + configs[
        "LOSS"] + '.mat',
                savedict)
else:
    sio.savemat(folderDataPath + 'confusion_matrix' + "/DeepDFML" + complemento + '_' + configs[
